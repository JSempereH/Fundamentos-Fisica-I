...
\declaretheorem[numbered=no, style=thmexplanationbox, name=Solución]{solucion}
\declaretheorem[numbered=no, style=thmproofbox, name=Proof]{replacementproof}
\declaretheorem[style=thmbluebox,  numbered=yes, name=Ejercicio]{ex}
